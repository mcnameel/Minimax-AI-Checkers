...
#ifndef MINIMAX_AI_CHECKERS_02_AI_EVALUATION_IMPL_06_H
#define MINIMAX_AI_CHECKERS_02_AI_EVALUATION_IMPL_06_H
...
public:
     ...
     */
    AI_Minimax_06(int lookAhead, Color color, bool usePruning)
        : AI(lookAhead, color, "Horizon Peek v1", usePruning) {};
...
#endif //MINIMAX_AI_CHECKERS_02_AI_EVALUATION_IMPL_06_H
